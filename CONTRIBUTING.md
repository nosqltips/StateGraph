# Contributing to StateGraph

Thank you for your interest in StateGraph! This project is building a new infrastructure primitive for the AI-native era, and contributions are welcome.
...
4. **Run an example**: `cargo run --example getting_started -p stategraph`
...
- **MCP resources**: Add MCP resource endpoints (`stategraph://state/{ref}/{path}`, etc.)
...
- **Schema is optional**: StateGraph must work without schemas. Schema features are additive.
